...
export const Whyab = () => {
  ...
  return (
    <>
      <div className="history bg-black text-white w-full pt-28  bg-gradient-to-b from-[#090808] via-[#232121] to-[#ded0d0] max-sm:h-500 max-sm:pt-16  ">

        <div className="part-1">
          <p className='ml-[46%] text-[16px] font-[800] text-yellow-300 max-sm:ml-40'>Our History</p>
          <h1 className='ml-[28%] text-[60px] font-semibold w-180 max-sm:ml-17 max-sm:text-[40px] max-sm:w-70 max-sm:text-center'>Redefining Quality Since </h1>
          <h1 className='ml-[41%] text-[60px] font-semibold max-sm:ml-33 max-sm:text-[40px]'>Day One</h1>
          <p className='ml-[27%] w-167 text-center mt-4 text-[16px] leading-[25px] font-normal max-sm:ml-2 max-sm:w-100'>Established in 2018, Aussie Buckets was born out of necessity to provide hard-working Australians with quality products at a fair price. We offer a comprehensive range of high-quality, 100% purpose-built products, making our heavy equipment the ultimate choice for all Australian operators. Our unique business model focuses on custom fabrication-on-demand, saving our customers thousands in unnecessary cost while providing a purpose-driven attachment, better suited to each customers’ requirements and setting a new standard for efficiency, quality and longevity.
          </p>
        </div>
