...
export const Industries = () => {
  return (
    <>
        <div className="industries flex justify-around mx-20 mt-20 mb-10 max-sm:block max-sm:mx-6 max-sm:overflow-hidden">
            <div className="info w-150 mt-8">
                <h1 className='text-[32px] mb-5 font-bold max-sm:w-100'>Expertise Across Every Industry</h1>
                <p className='text-[18px] max-sm:w-92'>We pride ourselves on bringing attachments to market built from the ground up with purpose and application in mind. We want to provide our community with the best solutions to solve the most challenging applications, and put attachment efficiency and longevity at the forefront of each and every design.</p>
                <button className='text-[16px] border-1 p-4 mt-5 hover:bg-black hover:text-white transition duration-300 max-sm:px-33'>All Industries</button>
            </div>

            <div className="Excava-buttons grid grid-cols-2 text-[16px] gap-3 max-sm:hidden">
